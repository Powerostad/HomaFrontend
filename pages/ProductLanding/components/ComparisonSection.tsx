...
const rugAfter = "https://images.unsplash.com/photo-1560185127-6ed189bf02f4?q=80&w=1200";
const beddingBefore = "https://images.unsplash.com/photo-1560185127-6ed189bf02f4?q=80&w=1200";
const beddingAfter = "https://images.unsplash.com/photo-1560185127-6ed189bf02f4?q=80&w=1200";
...
export function ComparisonSection() {
  ...
  return (
    <section className="relative w-full pt-12 pb-4 md:pt-20 md:pb-24 overflow-hidden bg-white">
      <div className="container relative z-10 mx-auto px-6">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div
            ref={containerRef}
            className="relative aspect-[4/5] md:aspect-[1.4/1] w-full overflow-hidden cursor-col-resize select-none bg-white border border-black/[0.03] rounded-[2px]"
