...
export function HeroSection({
    ...
    return (
        <section className="relative w-full bg-white overflow-hidden">
            ...
            {/* --- DESKTOP HERO --- */}
            <section className="hidden md:flex w-full h-screen bg-white overflow-hidden relative">
                {/* Visual Area (Left) */}
                ...
                {/* Content Area (Right) */}
                <div className="absolute top-0 right-0 z-20 w-[45%] h-full flex flex-col justify-start pt-52 pr-12 md:pr-16 lg:pr-32 pl-12" dir="rtl">
                    <motion.div
                    ...
                    >
                        {/* Label/Tag */}
                        <div className="flex items-center gap-6 opacity-60 mb-10">
                        ...
                        {/* Heading */}
                        <h1 className="font-light leading-[1.05] tracking-tighter md:text-[82px] lg:text-[104px] text-foreground mb-4 text-start w-full"> {/* Reduced mb from 8 to 4 */}
                            هُما؛ <span className="italic opacity-60 font-light">نسخه‌یِ بهترِ</span> <br />
                            خونه‌ت.
                        </h1>

                        {/* Paragraph */}
                        <p className="font-light leading-relaxed max-w-[480px] opacity-70 text-foreground mb-8 text-start text-[22px]"> {/* Reduced mb from 14 to 8 */}
                            هُما کمکت می‌کنه <br />
                            دکور مناسب خونه‌ت رو پیدا کنی.
                        </p>
                        ...
                        >
                            <span className="text-[14px] font-medium tracking-[0.3em] uppercase">نسخهٔ جدیدِ خونه‌تو ببین</span>
