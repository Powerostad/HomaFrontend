    ...
    return (
        <section className="relative w-full py-24 md:py-32 bg-white overflow-hidden">
                ...
                <div className="relative max-w-7xl mx-auto px-6 lg:px-16">
                    <div className="flex flex-col lg:flex-row items-stretch gap-12 lg:gap-16">
                        ...
                        <motion.div
                            ...
                            className="w-full lg:w-[65%] aspect-[1.4/1] overflow-hidden bg-white border border-black/[0.03] relative"
                        >
                            <BeforeAfterSlider
                        ...
                        <motion.div
                            ...
                            className="w-full lg:w-[35%] bg-[#F7F7F5] p-10 lg:p-14 border border-black/[0.05] flex flex-col justify-between"
                        >
                            <div>
                                ...
                                <div className="space-y-12">
                                    {PRODUCTS.map((product) => (
                                        <div key={product.id} className="group flex items-center justify-between gap-8">
                                            {/* Image on the Right */}
                                            <div className="w-28 h-28 bg-white flex items-center justify-center overflow-hidden border border-black/[0.03] transition-all duration-700 rounded-[1px] shrink-0">
            ...
            <div className="md:hidden flex flex-col px-6 space-y-10 pb-10">
                ...
                {/* Hero Result */}
                <div className="relative w-full aspect-[4/5] bg-[#F7F7F5] overflow-hidden border border-black/[0.03] rounded-[1px]">
                    <BeforeAfterSlider
                        beforeImage="https://images.unsplash.com/photo-1722858812150-2ff7011007cd?q=80&w=1600"
                        afterImage="https://images.unsplash.com/photo-1644057501622-dfa7dd26dbfb?q=80&w=1600"
                ...
                {/* Product List */}
                <div className="space-y-12 bg-[#F7F7F5] p-8 border border-black/[0.03] rounded-[1px]">
                    ...
                    <div className="space-y-10">
                        {PRODUCTS.map((product) => (
                            <div key={product.id} className="flex items-center gap-8">
                                <div className="w-20 h-20 bg-[#F9F9F9] overflow-hidden border border-black/[0.03] flex items-center justify-center shrink-0 rounded-[1px]">
